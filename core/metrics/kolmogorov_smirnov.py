...
def get_ecdf(sample: np.array,
             weights: np.array = None) -> Tuple[np.array, np.array]:
...
def _interleave_ecdfs(x1: np.array,
                      y1: np.array,
                      x2: np.array,
                      y2: np.array) -> Tuple[np.array, np.array, np.array]:
    """
...
def ks_2samp_w(data1: np.array,
               data2: np.array,
               w1: np.array = None,
               w2: np.array = None) -> float:
...
def weighted_ks(config: DictConfig,
